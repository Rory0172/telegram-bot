...
#
 permit_params :coin_id, :exchange, :entry_price_low, :entry_price_high, :sell_target_1_low, :sell_target_1_high, :sell_target_2_low, :sell_target_2_high, :stoploss, :note, :duration
